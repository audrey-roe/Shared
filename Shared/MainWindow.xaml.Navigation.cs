...
namespace Shared
{
    public sealed partial class MainWindow : INavigation
    {
        ...
        {
            SetCurrentNavigationViewItem(GetNavigationViewItems(typeof(SharedFiles)).First());
        }
        ...
        {
            return GetNavigationViewItems().Where(i => i.Tag != null && i.Tag.ToString() == type.FullName).ToList();
        }
